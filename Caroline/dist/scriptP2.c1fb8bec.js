...
fetch("https://rickandmortyapi.com/api/character").then(function (response) {
  ...
  var tabPerso = data.results;

  var _iterator = _createForOfIteratorHelper(tabPerso),
      _step;
...
function createCard(_ref) {
  ...
  cardContainer.innerHTML += "<h4 class=\"perso__name\">".concat(name, "</h4>\n        <span>Status : ").concat(status, "</span>\n        <span>Esp\xE8ce : ").concat(species, "</span>\n        <span>Type : ").concat(type, "</span>\n        <span>Genre : ").concat(gender, "</span>\n        <span>Origine : ").concat(origin.name, "</span>\n        <span>Dernier lieu : ").concat(location.name, "</span>"); // <ul>Episodes : <li>${episode}</li></ul>
}
...
},{}]},{},["C:/Users/cmfau/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scriptP2.js"], null)
